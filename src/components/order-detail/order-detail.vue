  ...
  <transition name="slide">
    <div class="order-detail">
      ...
      <div class="content">
        <div class="header">
          <img
            :src="order.shop.pic_url"
            class="shop-img"
          />
          <p class="state">订单已完成</p>
          <p class="desc">感谢您的信任，祝您用餐愉快</p>
        </div>
        <div class="order">
          <h1 class="shop-name">
      ...
      <div class="list-info">
        ...
        <ul class="list-detail">
          <li class="item">
            ...
            <div class="item-content">尽快送达（{{order.expectTime}}）</div>
          </li>
          <li class="item">
          ...
          <li class="item">
            ...
            <div class="item-content">商家配送</div>
          </li>
        </ul>
      </div>
      <div class="list-info">
        ...
        <ul class="list-detail">
          <li class="item">
            ...
            <div class="item-content">3019696409725325389</div>
          </li>
          <li class="item">
          ...
          <li class="item">
            ...
            <div class="item-content">{{order.orderTime}}</div>
          </li>
        </ul>
      </div>
    </div>
  ...
  .content {
    ...
    .order {
      ...
      .shop-name {
        ...
        padding: 1rem;
        border-bottom: 0.4vw solid #dfdfdf;
